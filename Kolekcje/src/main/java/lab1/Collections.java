...
public class Collections {
    ...
    private void Book() {
        ...
        Book fifthBook = new Book("Wonder", "R.J. Palacio", 2012);
    ...
    private void show() {
        ...
        switch (choice) {
            ...
            case 1:
                ...
                for (var movie : BookArrayList) {
                    String output = String.format("|%10s|%10s|%10d", movie.getBookName(), movie.getAuthor(), movie.getReleaseDate());
            ...
            case 2:
                ...
                for (var movie : BookLinkedList) {
                    String output = String.format("|%10s|%10s|%5d|%10s|", movie.getBookName(), movie.getAuthor(), movie.getReleaseDate());
